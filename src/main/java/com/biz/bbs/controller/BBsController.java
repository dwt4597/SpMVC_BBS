 ...
 * list : get
 * write : get : form 보이기
 * form write :post : db insert
 * view : get
 * 	update : get form보이기 post
 * 	delete : get
 */
...
public class BBsController {
	...
	public BBsVO newBbsVO() {
		...
		bbsVO.setB_userid("ijs92000@naver.com");
	...
	public String bbs_update(@ModelAttribute("bbsVO") BBsVO bbsVO, Model model, SessionStatus session) {
